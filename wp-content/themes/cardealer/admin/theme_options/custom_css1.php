...
if ($general_font_family === 'default_font') {
	$general_font_family = '';
}
...
if ($main_nav_font === 'default_font') {
	$main_nav_font = '';
}
$main_nav_level_2_font = TMM::get_option('main_nav_level_2_font');
if ($main_nav_level_2_font === 'default_font') {
	$main_nav_level_2_font = '';
}
...
if ($h1_font_family === 'default_font') {
	$h1_font_family = '';
}
...
if ($h2_font_family === 'default_font') {
	$h2_font_family = '';
}
...
if ($h3_font_family === 'default_font') {
	$h3_font_family = '';
}
...
if ($h4_font_family === 'default_font') {
	$h4_font_family = '';
}
...
if ($h5_font_family === 'default_font') {
	$h5_font_family = '';
}
...
if ($h6_font_family === 'default_font') {
	$h6_font_family = '';
}
...
if ($content_font_family === 'default_font') {
	$content_font_family = '';
}
...
if ($buttons_font_family === 'default_font') {
	$buttons_font_family = '';
}
