...
<div class="option">
    ...
    <div class="controls">
        ...
        <input type="hidden" value="<?php echo( isset($itemdata['slug']) ? $itemdata['slug'] : '' ) ?>" name="data_groups[<?php echo $data_group_index ?>][data][<?php echo $uniqid ?>][slug]" />
    </div>
